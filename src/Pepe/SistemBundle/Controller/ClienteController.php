...
use Pepe\SistemBundle\Entity\Cliente;
use Pepe\SistemBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SistemBundle:Cliente')->findAll();

        return $this->render('SistemBundle:Cliente:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SistemBundle:Cliente:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SistemBundle:Cliente')->find($id);
        ...
        return $this->render('SistemBundle:Cliente:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SistemBundle:Cliente:edit.html.twig', array(
            'entity'      => $entity,
