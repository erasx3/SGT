...
use Pepe\SistemBundle\Entity\Empleado;
use Pepe\SistemBundle\Form\EmpleadoType;
...
class EmpleadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SistemBundle:Empleado')->findAll();

        return $this->render('SistemBundle:Empleado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SistemBundle:Empleado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SistemBundle:Empleado')->find($id);
        ...
        return $this->render('SistemBundle:Empleado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SistemBundle:Empleado:edit.html.twig', array(
            'entity'      => $entity,
