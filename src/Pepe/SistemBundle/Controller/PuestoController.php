...
use Pepe\SistemBundle\Entity\Puesto;
use Pepe\SistemBundle\Form\PuestoType;
...
class PuestoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SistemBundle:Puesto')->findAll();

        return $this->render('SistemBundle:Puesto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SistemBundle:Puesto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SistemBundle:Puesto')->find($id);
        ...
        return $this->render('SistemBundle:Puesto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SistemBundle:Puesto:edit.html.twig', array(
            'entity'      => $entity,
